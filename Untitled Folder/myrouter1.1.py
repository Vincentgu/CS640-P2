...
class Router(object):
    ...
    def router_main(self, net): 
        ...
        for intf in my_interfaces:
            print (intf.name, intf.ipaddr, intf.ethaddr)
	    ...
	    # If there are NO Packets
            # Check the Arp Wait Queue:
            # If no ARP Reply: Send an Arp Request Again till count 5
            # If count more than 5, remove this packet from Queue.
